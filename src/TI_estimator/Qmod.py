...
from https://github.com/gl-ybnbxb/TI-estimator
'''
...
class QNetHyperparameterTuner:
    '''
    Class for Hyperparameter tuning for QNet
    ...
    obj = QNetHyperparameterTuner(T, Y, X, epoch = 100)
    ...
    def objective(self, trial):
        ...
        model.train(
            texts = self.X, 
            treatments = self.T, 
            confounders = np.zeros(len(self.T)), 
            outcomes = self.Y, 
        ...
        validation_loss = model.return_loss()
